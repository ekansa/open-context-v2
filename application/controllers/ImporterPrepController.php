...
class ImporterPrepController extends Zend_Controller_Action
{
    function init(){
	 ...
	 public function getFieldRelationsAction(){
		  $requestParams =  $this->_request->getParams();
		  ...
		  if(!isset($requestParams["sourceID"])){
				...
				$result = $fieldLinksObj->getFieldRelations();
	 ...
	 public function formAction(){
		  ...
		  if(isset($requestParams["sourceID"])){
				...
				$uploadTabObj->getBySourceID($sourceID);
				$projectUUID = $uploadTabObj->projectUUID;
		  }
